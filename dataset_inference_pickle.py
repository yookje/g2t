...
class TSPDataset(Dataset):
    ...
    def _readDataFile(self):
        ...
        self.reversed_tsp_tours = data['reversed_tsp_tours']
        ...
        with open('input_val_file.pkl', 'wb') as f:
            pickle.dump(data, f)
    ...
    def __getitem__(self, idx):
        return self.src[idx], self.tgt[idx], self.visited_mask[idx], self.ntokens[idx], self.tsp_tours[idx], self.reversed_tsp_tours[idx], self.src_fuzzy[idx]
...
if __name__ == "__main__":
    train_dataset = TSPDataset("input_val_file.pkl")
    #train_dataset = TSPDataset("tmp_val.txt")
