...
class TSPDataset(Dataset):
    def __init__(
        ...
        #modified for chuncked pickle data
    ...
    def _readDataFile(self):
        ...
        chunk_files = sorted(glob.glob(f'{self.data_path}_chunk_*.pkl'))
...
if __name__ == "__main__":
    train_dataset = TSPDataset("./emb_folder/tsp50_train_mid")
