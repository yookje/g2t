...
def end_discord(v_num,  node_size = None, G = None, G_hitratio = None, G_optgap = None,  elapsed_time2 = None):
    ...
    embed.add_embed_field(name=f"hitratio", value=str(round(G_hitratio,4)), inline = False)
...
def parse_arguments():
    ...
    parser.add_argument("--config", default="./inference_config.yaml", help="Path to the configuration YAML file.")
...
if __name__ == "__main__":
    ...
    end_discord(v_num, cfg.node_size, cfg.G, tsp_model.hit_ratio, tsp_model.optgap,elapsed_time2)
